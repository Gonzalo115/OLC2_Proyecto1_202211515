...
function peg$parse(input, options) {
  ...
  var peg$e15 = peg$literalExpectation("continue", false);
  var peg$e16 = peg$literalExpectation("return", false);
  ...
  var peg$e41 = peg$classExpectation([["\0", "\uFFFF"]], false, false);
  ...
  var peg$f3 = function(tipo, id, exp) { return exp };
  var peg$f4 = function(tipo, id, exp) { return crearNodo('declaracionVariable', { tipo, id, exp }) };
  var peg$f5 = function(exp) { return crearNodo('println', { exp }) };
  ...
  var peg$f9 = function(exp, casos, stmtDefault) { return stmtDefault};
  var peg$f10 = function(exp, casos, stmtDefault) { return crearNodo('switch', { exp, casos, stmtDefault  }) };
  var peg$f11 = function(cond, stmt) { return crearNodo('while', { cond, stmt }) };
  var peg$f12 = function(init, cond, inc, stmt) {
      return crearNodo('for', { init, cond, inc, stmt })
    };
  var peg$f13 = function() { return crearNodo('break') };
  var peg$f14 = function() { return crearNodo('continue') };
  var peg$f15 = function(exp) { return crearNodo('return', { exp }) };
  var peg$f16 = function(exp) { return crearNodo('expresionStmt', { exp }) };
  var peg$f17 = function(exp, stmt) { return crearNodo('casos', {exp, stmt}) };
  ...
  var peg$f22 = function(exp_left, exp_right) { return crearNodo('expresionPrintln', { exp_left, exp_right }) };
  var peg$f23 = function(cond, expTrue, expFalse) { return crearNodo('ternario', { cond, expTrue, expFalse } ) };
  var peg$f24 = function(id, asgn) { return crearNodo('asignacion', { id, asgn }) };
  var peg$f25 = function(id, valor) { return crearNodo('incremento', { id, valor }) };
  var peg$f26 = function(id, valor) { return crearNodo('decremento', { id, valor }) };
  var peg$f27 = function(id) { return crearNodo('dato', { valor: 1, tipo: "int"}) };
  var peg$f28 = function(id, valor) { return crearNodo('incremento', { id, valor }) };
  var peg$f29 = function(id) { return crearNodo('dato', { valor: -1, tipo: "int"}) };
  var peg$f30 = function(id, valor) { return crearNodo('incremento', { id, valor }) };
  var peg$f31 = function(exp_left, operacion, exp_right) { return { tipo: operacion, exp_right } };
  var peg$f32 = function(exp_left, expansion) { 
  ...
  var peg$f33 = function(exp_left, operacion, exp_right) { return { tipo: operacion, exp_right } };
  var peg$f34 = function(exp_left, expansion) { 
  return expansion.reduce(
    (operacionAnterior, operacionActual) => {
      const { tipo, exp_right } = operacionActual
      return crearNodo('logico', { operacion:tipo, exp_left: operacionAnterior, exp_right })
  ...
  var peg$f35 = function(exp_left, operacion, exp_right) { return { tipo: operacion, exp_right } };
  var peg$f36 = function(exp_left, expansion) { 
  return expansion.reduce(
    (operacionAnterior, operacionActual) => {
      const { tipo, exp_right } = operacionActual
  ...
  var peg$f43 = function(operacion, num) { return crearNodo('OperacionU', { operacion: operacion, exp_unica: num }) };
  var peg$f44 = function() { return crearNodo('dato', { valor: parseFloat(text()), tipo: "float"}) };
  var peg$f45 = function() { return crearNodo('dato', { valor: parseInt(text(), 10), tipo: "int"}) };
  var peg$f46 = function() { return crearNodo('dato',    { valor: text() === "true", tipo:"boolean"})};
  var peg$f47 = function(chars) { return crearNodo('dato',  { valor: chars.join(''), tipo: "string"});};
  var peg$f48 = function(chars) { return crearNodo('dato',    { valor: chars, tipo: "char"}); };
  var peg$f49 = function(exp) { return crearNodo('agrupacion', { exp }) };
  var peg$f50 = function(id) { return crearNodo('referenciaVariable',  { id }) };
